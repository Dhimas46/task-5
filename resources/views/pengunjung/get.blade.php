    ...
    <div class="card">
      <div class="card-header">
        <div class="float-right">
          <a data-toggle="modal" data-target="#exampleModal" class="btn btn-info"><i class="fa fa-plus"></i>&nbsp Tambah Data</a>
        </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <a class="btn btn-warning" data-toggle="modal" data-target="#modal-edit{{$row->id}}"><i class="fa fa-pencil-alt"></i>Edit</a>
                  <a id="btn-hapus" class="btn btn-danger"href="{{url('delete-participant/'.$row->id)}}"><i class="fa fa-trash"></i>Delete</a>
              </td>
